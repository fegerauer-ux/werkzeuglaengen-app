const CACHE_NAME='wl-app-v5';
const URLS=[
  '/werkzeuglaengen-app/app.html',
  '/werkzeuglaengen-app/manifest.json',
  '/werkzeuglaengen-app/icon-192.png',
  '/werkzeuglaengen-app/icon-512.png',
  '/werkzeuglaengen-app/apple-touch-icon.png'
];
